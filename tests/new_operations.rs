...
fn test_exp_basic() {
    ...
    assert!((actual[2] - (std::f32::consts::E * std::f32::consts::E)).abs() < 1e-5); // e^2 = e^2
}

#[test]
fn test_log_basic() {
    let tensor = Tensor::from_vec(vec![1.0, std::f32::consts::E, std::f32::consts::E.powi(2)], vec![3]).unwrap();
